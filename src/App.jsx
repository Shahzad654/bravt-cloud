    ...
    <Instance/> */}
      ...
      <Routes>
        ...
        <Route path="/storage" element={
          <PrivateRoute><Storage /></PrivateRoute>
        ...
        <Route path="/firewall" element={
          <PrivateRoute> <Firewall /></PrivateRoute>

        } />
        <Route path="/images" element={
          <PrivateRoute><Images /></PrivateRoute>
        ...
        <Route path="/link-code" element={
          <PrivateRoute> <LinkCode /></PrivateRoute>

        } />
        <Route path="/resource-record" element={
          <PrivateRoute>  <ResourceRecord /></PrivateRoute>
        ...
        <Route path="/authentication" element={
          <PrivateRoute> <Authentication /></PrivateRoute>

        } />
        <Route path="/deploy" element={
          <PrivateRoute>    <DeployInstance /> </PrivateRoute>

        } />
        <Route path="/billing-info" element={
          <PrivateRoute>  <BillingInfo /> </PrivateRoute>
