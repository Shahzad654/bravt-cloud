    ...
    <div className={cn("relative w-full pt-12", className)}>
      <div className="relative w-full pt-[20%]">
        ...
        <div
          ...
          rounded-[100%] border-4 border-brand bg-white/50 pt-[100%] 
        ...
        >
          {/* Animated Layers */}
          <div
            className="absolute -left-[50%] top-0 h-[200%] w-[200%] rounded-[100%] bg-brand-foreground/50"
            style={{
              maskImage:
          ...
          />
          <div
            className="absolute -left-[50%] top-0 h-[200%] w-[200%] rounded-[100%] bg-brand/50"
            style={{
              maskImage:
          ...
          />
          <div
            className="absolute -left-[50%] -top-[5%] h-[200%] w-[200%] rounded-[100%] bg-white"
            style={{
              maskImage:
