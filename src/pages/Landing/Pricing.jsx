        ...
        {isLoading
          ...
          : plans?.map((plan, index) => (
              <BlurFade
                key={plan.id}
                delay={(index + 1) * 0.25}
                className="relative overflow-hidden border shadow-xl max-h-fit border-zinc-100 bg-gradient-to-b from-white to-zinc-50 rounded-3xl"
              >
                <div className="p-8">
                  <div className="flex items-center justify-between mb-8">
                      ...
                      <>
                        ...
                        <div className="flex items-center mt-2">
                          <span className="text-lg line-through text-zinc-400">
                            {plan.promotionalPrice} credits/hour
                          </span>
                        </div>
                        <p className="mt-2 text-zinc-600 whitespace-nowrap">
                          or{" "}
                          ...
                          <span className="ml-2 line-through text-zinc-400">
                            (
                            {formatPrice(toMonthlyPrice(plan.promotionalPrice))}
                            )
                          </span>
                        </p>
                      </>
